...
// I will use the Graham's Scan algorithm to find the convex hull of the beat polygon
...
export const convexHull = (locs) => {
    // Convert locations array into points array
    const points = locs.map(loc => new Point(loc.coords))
